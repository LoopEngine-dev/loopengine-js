...
import type { FeedbackPayload, LoopEngineConfig, SendResult } from './types.js';
...
export class LoopEngine {
   ...
   */
  async send(payload: FeedbackPayload): Promise<SendResult> {
    const body = { ...payload, project_id: this.projectId };
